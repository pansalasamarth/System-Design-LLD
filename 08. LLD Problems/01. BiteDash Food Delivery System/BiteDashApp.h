#ifndef BiteDash_APP_H
#define BiteDash_APP_H
...
public:
    ...
    void initializeRestaurants() {
        Restaurant* restaurant1 = new Restaurant("Ganesh", "Surat");
        restaurant1->addMenuItem(MenuItem("P1", "AalooPuri", 50));
        restaurant1->addMenuItem(MenuItem("P2", "Cheese Papdi", 70));

        Restaurant* restaurant2 = new Restaurant("Haldiram", "Ahmedabad");
        ...
        Restaurant* restaurant3 = new Restaurant("Only Dosa", "Surat");
